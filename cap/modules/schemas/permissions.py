...
SchemaReadAction = action_factory('schema-object-read', parameter=True)

SchemaAdminAction = action_factory('schema-object-admin', parameter=True)
...
# deposit actions
deposit_schema_create_action = schema_needs_factory('deposit', 'create')
...
deposit_schema_delete_action = schema_needs_factory('deposit', 'delete')
...
deposit_schema_upload_action = schema_needs_factory('deposit', 'upload')

deposit_schema_create_action_all = deposit_schema_create_action(None)
...
deposit_schema_delete_action_all = deposit_schema_delete_action(None)
...
deposit_schema_upload_action_all = deposit_schema_upload_action(None)

# record actions
record_schema_create_action = schema_needs_factory('record', 'create')
...
record_schema_review_action = schema_needs_factory('record', 'review')
record_schema_clone_action = schema_needs_factory('record', 'clone')
record_schema_upload_action = schema_needs_factory('record', 'upload')

record_schema_create_action_all = record_schema_create_action(None)
...
record_schema_review_action_all = record_schema_review_action(None)
record_schema_clone_action_all = record_schema_clone_action(None)
record_schema_upload_action_all = record_schema_upload_action(None)
