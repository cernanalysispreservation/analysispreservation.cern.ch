...
def test_get_glance_by_id(mock_get_token, app, auth_headers_for_superuser):
...
@responses.activate
@patch('cap.modules.experiments.views.atlas.get_glance_token')
def test_get_glance_by_id_when_glance_server_down_returns_503(mock_get_token, app, auth_headers_for_superuser):
    glance_id = '111'
...
@patch('cap.modules.experiments.views.atlas.get_glance_token')
def test_get_glance_by_id_when_glance_server_doesnt_return_token_returns_503(mock_get_token, app, auth_headers_for_superuser):
    glance_id = '111'
