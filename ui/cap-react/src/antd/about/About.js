      ...
      <Col xs={20} md={16} lg={10}>
        ...
        <Space direction="vertical" size="middle">
          <Typography.Paragraph>
            ...
            service developed by the Scientific Information Service at CERN for
            physicists to preserve and document the various materials produced
            in the analysis process, e.g. datasets, code, documentation, so that
            they are reusable and understandable in the future. By using this
            tool, researchers ensure these outputs are preserved and also
            findable and accessible by their (internal) collaborators.
          </Typography.Paragraph>
          <Typography.Paragraph>
            To make the tool as easy to use as possible, an API and a dedicated
            client are available, as well as integrations with long-established
            collaboration databases and platforms. This reduces the burden on
            the users and minimises duplication of information. The researchers
            remain in full control of their information, while being able to
            preserve and share their data and materials easily with their
        ...
        <Typography.Paragraph>
          ...
          access control to all information added to CAP. Access will always be
          restricted to members of the collaboration associated with an
        ...
        <ul>
          <Space direction="vertical">
            <li>
              only collaboration members have access to a collaboration’s area,
              can create analyses and can see shared analyses
            </li>
            <li>
            ...
            <li>
              ...
              permission settings For more detailed information please refer to
              our documentation.
            </li>
          </Space>
        </ul>
        ...
        <Typography.Paragraph>
          ...
          team/working group/collaboration would like to start using CAP, please
          get in touch.
        </Typography.Paragraph>
      </Col>
    </Row>
