            ...
            <Box align="center" size="xxlarge">
              <Box margin={{ vertical: "medium" }}>
                ...
                <Paragraph style={{ lineHeight: "180%" }}>
                  CERN does not track, collect or retain personal information
                  from users of the CERN Analysis Preservation service, except
                  as otherwise provided herein. In order to enhance CERN
                  Analysis Preservation and monitor traffic, non-personal
                  information such as IP addresses and cookies may be tracked
                  and retained, as well as log files shared in aggregation with
                  other community services. User provided information, such as
                  metadata, will be integrated into the database without
                  displaying its source.
                </Paragraph>
                <Paragraph style={{ lineHeight: "180%" }}>
                  CERN Analysis Preservation will take all reasonable measures
                  to protect the privacy of its users and to resist service
