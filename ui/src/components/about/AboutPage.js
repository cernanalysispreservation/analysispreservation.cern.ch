          ...
          <Box align="center">
            <Box align="center" size="xxlarge">
              <Box margin={{ vertical: "medium" }}>
                ...
                <Paragraph>
                  CERN Analysis Preservation (CAP) is a service for physicists
                ...
                <Paragraph>
                  ...
                  for reusable research data analyses. Another related service
                  is the{" "}
                  <a href="http://opendata.cern.ch/">CERN Open Data portal</a>,
                  which can be used to publish openly various materials, such as
                  datasets, software, configuration files, etc. These services
                  are being developed and operated by the CERN IT and the
                ...
                <Box size="large">
                  <Paragraph>
                    As we are preserving sensitive data, we apply safety
                    measures and access control to all information added to CAP.
                    ...
                    analysis, defaulting to creator-only access. More
                    specifically:
                  </Paragraph>
                  <ul>
                    <li>
