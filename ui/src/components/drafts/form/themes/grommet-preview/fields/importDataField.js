        ...
        {this.state.layerActive ? (
          ...
          >
            <Box flex={true} size="medium">
              ...
              <List>
                {this.state.data ? (
                  this.state.data.map((r, index) => (
                    <ListItem
                      key={index}
                      onClick={this._selectItem.bind(this, r)}
                    >
                      <span>
                        {r.metadata.general_title ||
                          r.metadata.$ana_type ||
                          "-----"}
                      </span>
                    </ListItem>
              ...
              <Label>
                <span>
                  You have selected {this.props.schema.title}:{" "}
                  <strong>
                    {this.state.selected
                      ? this.state.selected.metadata
                        ? this.state.selected.metadata.general_title
                        : ""
                      : "---"}
                  </strong>
                </span>
              ...
              <Box flex={true} pad="small" justify="between" direction="row">
                ...
                />
                <Button label="Cancel" onClick={this._toggleLayer.bind(this)} />
              </Box>
            </Box>
          </Layer>
        ) : null}
                ...
                >
                  ...
                  >
                    {this.state.selected
                      ...
                      : "---"}
                    <Anchor
                      href={this.state.selected.links.self}
                      icon={<Link size="xsmall" />}
                    />
                  </Box>
                  <Button
                    icon={<Edit />}
